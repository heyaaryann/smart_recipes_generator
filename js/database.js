...
const RECIPES = [
  ...
  },
  {
    ...
    cuisine: "Indian",
    emoji: "🍛",
    description: "Tender marinated chicken in a rich, spiced tomato-cream sauce — a global favourite.",
    ingredients: ["chicken breast", "yogurt", "tomato", "onion", "garlic", "ginger", "heavy cream", "butter", "cumin", "garam masala", "paprika", "coriander"],
    steps: [
      "Marinate chicken in yogurt, garlic, ginger, cumin, paprika, and garam masala for at least 30 mins.",
      ...
      "Stir in cream and add the grilled chicken. Simmer 10 mins. Garnish with coriander."
    ],
    nutrition: { calories: 480, protein: 38, carbs: 18, fat: 28, fiber: 4 },
    difficulty: "Medium",
    cookTime: 50,
    dietary: ["gluten-free"],
    servings: 4,
  ...
  },
  {
    ...
    cuisine: "Mediterranean",
    emoji: "🐟",
    description: "Pan-seared salmon with a bright lemon-garlic butter sauce. Ready in 20 mins.",
    ingredients: ["salmon", "lemon", "garlic", "butter", "olive oil", "thyme", "salt", "pepper"],
    steps: [
      "Pat salmon dry. Season generously with salt and pepper.",
      "Heat olive oil in a pan over high heat. Place salmon skin-side down. Cook 4 mins without moving.",
      "Flip and cook 3 more mins. Transfer to a plate.",
      "Add butter, garlic, and thyme to the same pan. Sauté 1 min.",
      "Pour lemon juice into the pan. Spoon sauce over salmon. Serve."
    ],
    nutrition: { calories: 410, protein: 42, carbs: 3, fat: 25, fiber: 0 },
    difficulty: "Easy",
    cookTime: 20,
  ...
  },
  {
    ...
    cuisine: "Asian",
    emoji: "🥩",
    description: "Tender beef strips with colourful vegetables in a savoury oyster sauce glaze.",
    ingredients: ["beef", "broccoli", "bell pepper", "onion", "garlic", "soy sauce", "oyster sauce", "sesame oil", "cornstarch", "ginger"],
    steps: [
      "Slice beef thinly. Marinate with soy sauce, cornstarch, and sesame oil for 15 mins.",
      "Blanch broccoli in boiling water 2 mins. Drain.",
      "Stir-fry beef over high heat until browned. Remove.",
      "In same wok, sauté garlic and ginger. Add peppers and onion — cook 3 mins.",
      "Return beef. Add broccoli, oyster sauce, and a splash of water. Toss and serve over rice."
    ],
    nutrition: { calories: 430, protein: 35, carbs: 22, fat: 22, fiber: 4 },
    difficulty: "Medium",
    cookTime: 30,
    dietary: ["dairy-free"],
    servings: 3,
  ...
  },
  {
    ...
    ingredients: ["romaine lettuce", "parmesan", "bread", "egg", "garlic", "lemon", "olive oil", "worcestershire sauce", "black pepper", "anchovy"],
    steps: [
      "Cube bread and toast in olive oil and garlic in the oven at 180°C for 10 mins.",
      "Whisk together egg yolk, garlic, anchovy paste, lemon juice, worcestershire sauce, and olive oil for dressing.",
  ...
  },
  {
    ...
    cuisine: "Asian",
    emoji: "🍜",
    description: "Tangy and spicy Thai soup with shrimp, lemongrass, and mushrooms.",
    ingredients: ["shrimp", "mushroom", "lemongrass", "kaffir lime leaves", "galangal", "tomato", "fish sauce", "lime", "chili", "coconut milk"],
    steps: [
      "Boil water with lemongrass, galangal, and kaffir lime leaves for 10 mins.",
      "Add mushrooms and tomatoes — cook 5 mins.",
      "Add shrimp and cook just until pink, about 3 mins.",
      "Season with fish sauce, lime juice, and chilies.",
      "Stir in coconut milk for creaminess. Serve immediately."
    ],
    nutrition: { calories: 240, protein: 22, carbs: 14, fat: 10, fiber: 2 },
    difficulty: "Medium",
    cookTime: 25,
    dietary: ["gluten-free", "dairy-free"],
    servings: 3,
  ...
  },
  {
    ...
    cuisine: "Indian",
    emoji: "🍲",
    description: "Melt-in-your-mouth chicken in a velvety tomato-butter-cream sauce.",
    ingredients: ["chicken", "butter", "tomato", "onion", "garlic", "ginger", "heavy cream", "cashews", "garam masala", "turmeric", "paprika"],
    steps: [
      "Marinate chicken in yogurt, turmeric, and paprika. Pan-fry until cooked.",
      ...
      "Add cooked chicken. Simmer 10 mins. Finish with butter and cream."
    ],
    nutrition: { calories: 520, protein: 36, carbs: 16, fat: 36, fiber: 3 },
    difficulty: "Medium",
    cookTime: 55,
    dietary: ["gluten-free"],
    servings: 4,
  ...
  },
  {
    ...
    cuisine: "American",
    emoji: "🍔",
    description: "Juicy smash-style beef burger with all the classic toppings on a brioche bun.",
    ingredients: ["ground beef", "burger bun", "lettuce", "tomato", "onion", "cheese", "pickles", "ketchup", "mustard", "mayonnaise", "salt", "pepper"],
    steps: [
      "Season ground beef with salt and pepper. Form into patties.",
      "Heat a cast iron skillet until smoking hot. Smash patties down thin. Cook 2 mins per side.",
    ...
    nutrition: { calories: 610, protein: 34, carbs: 42, fat: 34, fiber: 2 },
    difficulty: "Easy",
    cookTime: 20,
    dietary: [],
    servings: 2,
  ...
  },
  {
    ...
    cuisine: "Asian",
    emoji: "🍤",
    description: "Authentic Pad Thai with rice noodles, shrimp, bean sprouts, and peanuts.",
    ingredients: ["rice noodles", "shrimp", "egg", "bean sprouts", "peanuts", "green onion", "fish sauce", "tamarind paste", "palm sugar", "garlic", "lime"],
    steps: [
      "Soak rice noodles in warm water for 20 mins. Drain.",
      "Stir-fry shrimp and garlic in hot oil until pink. Push to side.",
      "Scramble eggs in the same pan.",
      "Add noodles, fish sauce, tamarind, and sugar. Toss everything together.",
      "Add bean sprouts and green onion. Plate and top with crushed peanuts and lime."
    ],
    nutrition: { calories: 470, protein: 28, carbs: 56, fat: 14, fiber: 3 },
    difficulty: "Medium",
    cookTime: 30,
    dietary: ["gluten-free", "dairy-free"],
    servings: 2,
